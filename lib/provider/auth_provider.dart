...
import 'package:bed3a_ecommerce/data/model/response/response_model.dart';
import 'package:bed3a_ecommerce/data/model/response/social_login_model.dart';
  ...
  Future registration(RegisterModel register, Function callback) async {
    ...
    if (apiResponse.response!.statusCode == 200) {
      ...
      if (apiResponse.error is String) {
        ...
        ErrorResponse errorResponse = apiResponse.error;
        print(errorResponse.errors![0].message.toString());
        errorMessage = errorResponse.errors![0].message ?? '';
      }
      callback(false, '', '', errorMessage);
      notifyListeners();
