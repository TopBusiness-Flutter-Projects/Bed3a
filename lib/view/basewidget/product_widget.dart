...
class _ProductWidgetState extends State<ProductWidget> {
  ...
  void initState() {
    ...
    super.initState();
    Provider.of<ProductProvider>(context, listen: false).initData(widget.productModel!,widget.productModel.minimumOrderQuantity, context);
  ...
  Widget build(BuildContext context) {
    ...
    return  Consumer<ProductProvider>(
        builder: (ctx, details, child){
          ...
          String? _variantName = (widget.productModel.colors != null && widget.productModel.colors!.length != 0) ? widget.productModel.colors![details.variantIndex!].name : null;
          List<String> _variationList = [];
          for(int index=0; index < widget.productModel.choiceOptions!.length; index++) {
            _variationList.add(widget.productModel.choiceOptions![index].options![details.variationIndex![index]].trim());
          ...
          if(details.variantIndex! >= widget.productModel.images!.length){
            selectedIndex = details.variantIndex! - (widget.productModel.colors!.length - widget.productModel.images!.length);
          }else{
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Visibility(
                        ...
                        child: InkWell(
                          onTap: _stock! < widget.productModel.minimumOrderQuantity!  &&  widget.productModel.productType == "physical" ? null :() {
                            if(_stock! >= widget.productModel.minimumOrderQuantity!  || widget.productModel.productType == "digital") {
                              CartModel cart = CartModel(
                                  widget.productModel.id,widget.productModel.id, widget.productModel.thumbnail, widget.productModel.name,
                                  widget.productModel.addedBy == 'seller' ?
                                  ...
                                  (widget.productModel.colors != null && widget.productModel.colors!.length > 0) ? widget.productModel.colors![details.variantIndex!].name : '',
                                  (widget.productModel.colors != null && widget.productModel.colors!.length > 0) ? widget.productModel.colors![details.variantIndex!].code : '',
                                  _variation, widget.productModel.discount, widget.productModel.discountType, widget.productModel.tax, widget.productModel.taxModel,
                                  widget.productModel.taxType, 1, '',widget.productModel.userId,'','','', widget.productModel.choiceOptions,
                                  Provider.of<ProductProvider>(context, listen: false).variationIndex,
                                  widget.productModel.isMultiPly==1? widget.productModel.shippingCost!*details.quantity! : widget.productModel.shippingCost ??0,
                                  widget.productModel.minimumOrderQuantity, widget.productModel.productType,widget.productModel.slug
                              );
                            ...
                            children: [
                              Padding(
                                ...
                                child: QuantityButton(isIncrement: false, index: widget.index,
                                  ...
                                  maxQty: widget.productModel.totalCurrentStock,
                                  productModel: widget.productModel, minimumOrderQuantity: widget.productModel.minimumOrderQuantity,
                                  digitalProduct: widget.productModel.productType == "digital"? true : false,

                                ),
                              ),
                              Spacer(),
                              Text(widget.productModel.quantity.toString(), style: titilliumSemiBold),
                              Spacer(),
                              Padding(
